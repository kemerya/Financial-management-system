...
namespace Financial_Managment_System
{
    public partial class Income : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            //if (!Page.IsPostBack)//{//    saveIncome();//    GridView1.DataBind();//}


        }
        //protected override void Render(HtmlTextWriter writer)
        //{
        //    // Register the control for event validation during the Render phase
        //    ClientScript.RegisterForEventValidation(GridView1.DataBind).UniqueID);
