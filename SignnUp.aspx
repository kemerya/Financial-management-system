...
<body>
    ...
    <div class="mb-3">
        ...
        <asp:TextBox class="form-control" ID="TextBox1" runat="server" Width="270px" required></asp:TextBox>
    </div>

    <div class="mb-3">
        <label for="TextBox2">Last Name:</label>
        <asp:TextBox class="form-control" ID="TextBox2" runat="server" Width="270px" required></asp:TextBox>
    </div>

    <div class="mb-3">
        <label for="TextBox3">Email:</label>
        <asp:TextBox class="form-control" ID="TextBox3" runat="server" Width="270px" required type="email"></asp:TextBox>
    </div>

    <div class="mb-3">
        <label for="TextBox4">Username:</label>
        <asp:TextBox class="form-control" ID="TextBox4" runat="server" Width="270px" required></asp:TextBox>
    </div>

    <div class="mb-3">
        <label for="TextBox5">Password:</label>
        <asp:TextBox class="form-control" ID="TextBox5" runat="server" Width="270px" required TextMode="Password" min="8" MaxLength="15"></asp:TextBox>
    </div>

    <div class="mb-3">
        <label for="TextBox6">Confirm Password:</label>
        <asp:TextBox class="form-control" ID="TextBox6" runat="server" Width="270px" required TextMode="Password"></asp:TextBox>
    </div>
    ...
    <!-- Sign up button -->
    <div class="mb-3">
        <asp:Button class="btn btn-primary btn-block" ID="Button1" runat="server" OnClientClick="return validatePassword()" OnClick="Button1_Click" Text="Sign Up" Width="260px" />
        <a href="SignIn.aspx" class="btn btn-secondary btn-block" onclick="toggleForm()">Back to Login</a>
    </div>
</div>
