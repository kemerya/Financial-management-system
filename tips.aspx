                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox class="form-control" ID="TextBox2" Height="200px"
                                                runat="server" required="text" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <%--  <label>Add</label>--%>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="tips-container" id="tipsContainer">
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Financial_Management_SystemConnectionString %>" SelectCommand="SELECT * FROM [Tip_table]" OnSelecting="SqlDataSource1_Selecting2"></asp:SqlDataSource>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <asp:GridView class="table table-striped table-bordered" ID="GridView1"
                                            runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged2">
                                            <Columns>
